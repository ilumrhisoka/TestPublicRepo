...
public class SessionService {
    ...
    public SessionResponseDTO getFirstDesktopSession(DeviceType deviceType) {
        Session session = sessionRepository.getFirstDesktopSession(deviceType);
        if (session == null) {
            return null;
        }
    ...
    public List<SessionResponseDTO> getSessionsFromActiveUsersEndedBefore2025() {
        ...
        // Преобразуем список сущностей Session в список SessionResponseDTO
